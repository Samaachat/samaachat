...
CREATE TABLE `Order` (
    ...
    `unitPrice` INTEGER NOT NULL DEFAULT 13250,
    `finalUnitPrice` INTEGER NULL,
...
-- AddForeignKey
ALTER TABLE `PriceTier` ADD CONSTRAINT `PriceTier_campaignId_fkey` FOREIGN KEY (`campaignId`) REFERENCES `Campaign`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
